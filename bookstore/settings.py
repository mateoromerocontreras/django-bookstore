...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-5ah4m6gnl!y6hollgti5sto1_7k2#d*y_qc+!h%!_wr(^=c!3*"
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get("DEBUG", "False") == "True"

# Parse ALLOWED_HOSTS, stripping whitespace and filtering empty strings
...
if os.environ.get("DATABASE_URL"):
    ...
    DATABASES = {
        "default": {
            ...
            "USER": os.environ.get("POSTGRES_USER", "bookstore_user"),
...
if not DEBUG:
    ...
    # SameSite=None required for cross-domain requests (frontend on different domain than backend)
    SESSION_COOKIE_SAMESITE = "None"
    CSRF_COOKIE_SAMESITE = "None"
else:
    # Local development - allow cookies without SameSite restrictions
